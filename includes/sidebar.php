...
<div id="postbox-container-1" class="postbox-container">
	<div class="meta-box-sortables">
		<div class="postbox">
			...
			<div class="inside">
				<p>Plugin Name : <?php echo CBXWOOCOUPONREFFERAL_BASENAME; ?> <?php echo CBXWOOCOUPONREFFERAL_VERSION; ?></p>

				<p>Author : <?php echo CBXWOOCOUPONREFFERAL_AUTHOR; ?></p>
				...
				<p>Linkedin : <a href="http://linkedin.com/company/codeboxr" target="_blank">codeboxr</a></p>
		...
		<div class="postbox">
			<h3><?php _e( 'Help & Supports', 'cbxwoocouponreferral' ); ?></h3>
		...
		<div class="postbox">
			<h3><?php _e( 'Codeboxr Updates', 'cbxwoocouponreferral' ); ?></h3>
		...
		<div class="postbox">
			<h3><?php _e( 'Codeboxr on facebook', 'cbxwoocouponreferral' ) ?></h3>
