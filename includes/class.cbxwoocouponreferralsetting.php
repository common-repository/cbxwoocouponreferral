 ...
 */
if ( ! class_exists( 'CBXWoocouponreferralSetting' ) ):

	class CBXWoocouponreferralSetting {
		...
		function callback_file( $args ) {
			...
			$label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'cbxwoocouponreferral');
